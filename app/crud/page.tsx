        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/80 backdrop-blur-sm">
          <div className="text-center">
            <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-blue-500/20 border border-blue-400/30">
              <span className="text-2xl font-bold text-blue-300">{countdown}</span>
            </div>
            <p className="text-white text-lg font-semibold">Logout berhasil</p>
            <p className="text-white/70 text-sm mt-1">Mengalihkan ke halaman login...</p>
          </div>
        </div>
      )}
